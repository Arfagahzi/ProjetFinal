...
@section('contenu')
    ...
    {{-- Style--}}
    <link rel="stylesheet" href="/css/teacher_change_pass.css">
    {{-- Style--}}

    <a href="{{route('show_master')}}"><button type="button" class="btn btn-primary">Retour</button></a>
    <hr>
    ...
    <div class="container">
        ...
        <div class="content">
            <form action="{{route('teacher_change_pass')}}" method="post" enctype="multipart/form-data">
                @csrf
