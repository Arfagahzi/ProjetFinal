...
{{--                <h2 class="header2"> Bienvenue:  {{ Auth::user()->name }}  </h2>--}}
...
{{--                <a href="{{route('show_add_filiere')}}" class="navigation-item-link">Ajouter filiere</a>--}}
{{--            </li>--}}
...
{{--                            {{csrf_field()}}--}}
{{--                            <input type="hidden" class="form-control" id="master" name="id" value="{{$filieres->id}}">--}}
{{--                            <div class="col-md-12 form-group">--}}
{{--                                <label class="creditcardtext" >Filiere <span style="color:red"> * </span></label>--}}
{{--                                <input type="text" class="form-control"  value="{{$filieres->filiere}}" name="filiere">--}}
{{--                                @error('filiere')--}}
...
{{--                                    <option value="{{$filieres->niveau}}">{{$filieres->niveau}}</option>--}}
