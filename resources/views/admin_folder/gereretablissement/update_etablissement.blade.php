...
{{--                <a href="{{route('show_add_etablissement')}}" class="navigation-item-link">Ajouter master</a>--}}
{{--            </li>--}}
...
{{--                <div class="col-md-8 col-12 mr-3">--}}
{{--                    <div class="row">--}}
{{--                        <form method="post" action="{{route('add_etablissement')}}">--}}
{{--                            {{csrf_field()}}--}}
{{--                            <div class="col-md-12 form-group">--}}
{{--                                <label class="creditcardtext" >Etablissement <span style="color:red"> * </span></label>--}}
...
<div class="container">
    ...
    <br>
    <div class="content">
        <form action="{{route('update_master_page')}}" method="post">
            {{csrf_field()}}
            <div class="mb-3">
                <input type="hidden" class="form-control" id="master" name="id" value="{{$etablissements->id}}">
