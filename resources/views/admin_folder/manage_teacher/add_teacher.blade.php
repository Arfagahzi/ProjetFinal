...
{{--                <h2 class="header2"> {{ Auth::user()->name }} </h2>--}}
...
{{--                <a href="{{route('add_teacher_page')}}" class="navigation-item-link">Ajouter enseignant</a>--}}
{{--            </li>--}}
            ...
            <form action="add_teacher" method="post">
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" name="nom" placeholder="Insérer Votre Nom" required>
                        @error('nom')
                        <li>  <small class="form-text text-danger">{{$message}}</small></li>
                        @enderror
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text"  name="prenom"  placeholder="Insérer Votre Prenom" required>
                        @error('prenom')
                        <li>  <small class="form-text text-danger">{{$message}}</small></li>
                        @enderror
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="email" placeholder="Insérer Votre Adresse" required>
                        @error('email')
                        <li>  <small class="form-text text-danger">{{$message}}</small></li>
                        @enderror
                    </div>
