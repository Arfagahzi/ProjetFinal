...
">
    ...
    <div class="sidebar-menu">
        <ul>
            <li>
                <a href="{{route('home_admin')}}" class="active">
...
<div class="main-content">
    <header style="  padding-bottom: 2%;">
        <h2>
         ...
         Administrateur : {{ Auth::user()->name }} {{ Auth::user()->last_name }}
        </h2>

        {{--        <div class="user-wrapper">--}}
        {{--            <img src="https://media-exp1.licdn.com/dms/image/C4E0BAQE3tYBbedpBuw/company-logo_200_200/0/1526295483398?e=2159024400&v=beta&t=8p4b1f4rN4VlzsOljoeVjejZ_4Za0QPX5ekrFX8r7ls"--}}
