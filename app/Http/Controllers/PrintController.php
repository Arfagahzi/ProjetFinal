...
<h3 align="center">Liste des enssignants pour la master '.$master->title.' </h3>
    ...
    <th style="border: 1px solid; padding:12px;" width="20%">Prénom</th>
...
<table>
  ...
  <td>Etudiant(e)</td>
    ...
    <tr>
  <td>Numéro du portable :</td>
  <td hidden></td>
  <td hidden></td>
  <td>'.$student->phone.'</td>
  </tr>
    <tr>
  <td>Nature du baccalauréat :</td>
  <td hidden></td>
  <td hidden></td>
  <td>'.$d->bac.'</td>
  </tr>
    <tr>
  <td>Année du baccalauréat :</td>
  <td hidden></td>
  <td hidden></td>
  <td>'.$d->Annee_bac.'</td>
  </tr>
